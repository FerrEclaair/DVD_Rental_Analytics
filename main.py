...
# CONFIG
# ---------------------------------------------------------------------
DEFAULT_DB_URL = "postgresql+psycopg2://postgres:123456@localhost:5432/dvd_project_database"
...
# ============================================================
# TIME SERIES FORECAST ENDPOINT (Simple ML)
# ============================================================
...
def api_forecast(req: ForecastRequest):
    """Endpoint untuk time series forecasting."""
    result = run_forecast(engine, req.dataset, req.horizon)
    return result